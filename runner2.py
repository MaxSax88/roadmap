...
def extract_shape_outline(image_path, resize_dim=(500, 500)):
    ...
    contours, _ = cv2.findContours(cannyimg, cv2.RETR_EXTERNAL, cv2.CHAIN_APPROX_NONE)
    """
    ...
    if contours:
        ...
        print(shape_points)
        plt.scatter(shape_points[0], shape_points[1])
        plt.show()
        return shape_points
    return []
...
def main():
    shape_image = r"C:\Users\mgbsa\Desktop\Elefant-lineart.png"  # Replace with your elephant outline image
